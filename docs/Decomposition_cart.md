...
Предполагаемое время выполнения - 2 часа / реальное время выполнения - 3 часа

2)Кнопка оплаты отправляет запрос:
• При успехе — подтверждение;
• При ошибке — всплывающее окно с кнопками «Повторить»/«Отмена».
Предполагаемое время выполнения - 1 час / реальное время выполнения - 1 час

3)Замена в экране заказа моковых нфт на нфт полученных при сетевом запросе.
Предполагаемое время выполнения - 2,5 часа / реальное время выполнения - 3 часа
...
5)Put-запрос на удаление из корзины
Предполагаемое время выполнения - 1,5 часа / реальное время выполнения - 2 часа

Предполагаемое время выполнения  3 части - 7 часов 30 минут / реальное время выполнения 3 части - 9 часов 15 минут

## **Дополнительно:**
1)Добавления локализации(Английский).
Предполагаемое время выполнения - 1,5 час /  реальное время выполнения - 1,5 часа
...
Предполагаемое время выполнения диплома - 16 часов 30 минут /  реальное время выполнения диплома - 16 часов 10 минут
